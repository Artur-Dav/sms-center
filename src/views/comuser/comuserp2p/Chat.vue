            ...
            <vs-divider class="d-theme-border-grey-light m-0" />
                ...
                <div >
                  <label class="opacity-75">
                    <h3 class="text-primary md-4 mt-4 mb-4 ml-4">Number</h3>                  
                    <v-select :options="number" :clearable="false" :dir="$vs.rtl ? 'rtl' : 'ltr'" class="text-primary ml-8 mr-8"/>
                  </label>
                </div>
...
export default {
  data () {
    return {
      ...
      number: [
        { label: '123456', value: 'all' },
        { label: '234567', value: 'sales' },
        { label: '345678', value: 'development' },
        { label: '456789', value: 'management' }
      ],
      clickNotClose        : true,
