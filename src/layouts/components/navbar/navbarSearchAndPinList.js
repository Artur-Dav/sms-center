...
export default {
  pages: {
    ...
    data: [
      ...
      //Admin 08.27
      {title: "Admin",                      url: "/admin/reseller",                     icon: "UserIcon",           is_bookmarked: false},
      {title: "Invoice",                    url: "/admin/invoice",                      icon: "FileIcon",           is_bookmarked: false},
      {title: "Dashboard",                  url: "/admin/dashboard",                    icon: "HomeIcon",           is_bookmarked: false},
      {title: "Payment",                    url: "/admin/payment",                      icon: "CreditCardIcon",     is_bookmarked: false},
      {title: "Usage",                      url: "/admin/usage",                        icon: "GridIcon",           is_bookmarked: false},
      {title: "Rate",                       url: "/admin/rate",                         icon: "HelpCircleIcon",     is_bookmarked: false},

      //Reseller 08.27
      {title: "Reseller",                   url: "/reseller/dashboard",                 icon: "HomeIcon",           is_bookmarked: false},
      {title: "Companies",                  url: "/reseller/company",                   icon: "ListIcon",           is_bookmarked: false},
      {title: "User View",                  url: "/reseller/user",                      icon: "UserIcon",           is_bookmarked: false},
      {title: "Invoice",                    url: "/reseller/invoice",                   icon: "FileIcon",           is_bookmarked: false},
      {title: "Payment",                    url: "/reseller/payment",                   icon: "CreditCardIcon",     is_bookmarked: false},
      {title: "Profile",                    url: "/reseller/profile",                   icon: "GridIcon",           is_bookmarked: false},
      {title: "ANI Pool",                   url: "/reseller/anipool",                   icon: "CheckSquareIcon",    is_bookmarked: false},

      //Company 08.27
      {title: "Dashboard",                  url: "/company/dashboard",                  icon: "HomeIcon",           is_bookmarked: false},
      {title: "User List",                  url: "/company/user",                       icon: "UserIcon",           is_bookmarked: false},
      {title: "Chat",                       url: "/company/chat",                       icon: "MessageSquareIcon",  is_bookmarked: false},
      {title: "User List",                  url: "/company/list",                       icon: "ListIcon",           is_bookmarked: false},
      {title: "Number List",                url: "/company/numlist",                    icon: "EditIcon",           is_bookmarked: false},
      {title: "Call Flow",                  url: "/company/callflow",                   icon: "ListIcon",           is_bookmarked: false},
      {title: "SMS Template",               url: "/company/template",                   icon: "BoldIcon",           is_bookmarked: false},
      {title: "Message Template",           url: "/company/msgtemplate",                icon: "ArchiveIcon",        is_bookmarked: false},
      {title: "Tips-Response",              url: "/company/tipsresponse",               icon: "PlusCircleIcon",     is_bookmarked: false},      
      {title: "Auto Responding",            url: "/company/auto",                       icon: "BoldIcon",           is_bookmarked: false},
      {title: "Payment",                    url: "/company/payment",                    icon: "CreditCardIcon",     is_bookmarked: false},
      {title: "Contact",                    url: "/company/mynum",                      icon: "MonitorIcon",        is_bookmarked: false},
      {title: "Contact-List",               url: "/company/list",                       icon: "FileTextIcon",       is_bookmarked: false},
      {title: "Invoice",                    url: "/company/invoice",                    icon: "FileIcon",           is_bookmarked: false},
      {title: "Report",                     url: "/company/analytic/report",            icon: "AlertCircleIcon",    is_bookmarked: false},
      {title: "SMS Log",                    url: "/company/analytic/smslog",            icon: "AlertCircleIcon",    is_bookmarked: false},
      
      //User 08.27
      {title: "Dashboard",                  url: "/user/dashboard",                     icon: "HomeIcon",           is_bookmarked: false},
      {title: "Contact",                    url: "/user/contact",                       icon: "MonitorIcon",        is_bookmarked: false},
      {title: "Chat",                       url: "/user/chat",                          icon: "MessageSquareIcon",  is_bookmarked: false},
      {title: "Campaign",                   url: "/user/campaign",                      icon: "ListIcon",           is_bookmarked: false},
      {title: "Report",                     url: "/user/report",                        icon: "AlertCircleIcon",    is_bookmarked: false},
      {title: "SMS Log",                    url: "/user/smslog",                        icon: "AlertCircleIcon",    is_bookmarked: false},
       //Company User 08.27
      {title: "Report",                     url: "/comuser/comreport",                  icon: "AlertCircleIcon",    is_bookmarked: false},
      {title: "SMS Log",                    url: "/comuser/smslog",                     icon: "AlertCircleIcon",    is_bookmarked: false},
      {title: "P2P Campaign",               url: "/comuser/userp2p",                    icon: "BookIcon",           is_bookmarked: false},
